...
dfm::pt::node dfm::pt::parse::value_array_item_param(
    const std::vector< dfm::lexer::token_type >& tokens, const size_t pos)
{
    ...
    dfm::pt::node n;
    {
        n.type = dfm::pt::ntypes::VALUE_ARRAY_ITEM_PARAM;
        n.rule = RULE;

        auto i = pos;
        i += dfm::pt::parse::consume_whitespace(n, tokens, i);

        n.children.push_back(dfm::pt::parse::value_array_item_param_name(tokens, i));
