...
template < typename T >
T dfm::utils::io::load_from_file(const std::filesystem::path& path)
{
...
template < typename T >
size_t dfm::utils::io::save_to_file(const T& data, const std::filesystem::path& path)
{
    // Determine mmap size
...
template < typename InputIt >
size_t dfm::utils::io::save_to_file(InputIt begin, InputIt end, const std::filesystem::path& path)
{
